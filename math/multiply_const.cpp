...
GRAS_REGISTER_FACTORY("/grex/multiply_const_v_" #suffix, make_multiply_const_v_ ## suffix) \
...
GRAS_REGISTER_FACTORY("/grex/multiply_const_" #suffix, make_multiply_const_ ## suffix)
