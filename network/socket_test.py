...
class test_socket_message(unittest.TestCase):
    ...
    def do_loop(self, to_socket, from_socket):
        ...
        s2d = gras.make('/ex/stream_to_datagram', numpy.dtype(numpy.int32).itemsize, 0)
    ...
    def test_udp_loopback(self):
        udp_server = gras.make('/ex/socket_message', "UDP_SERVER", 'localhost', '34567', 0)
        udp_client = gras.make('/ex/socket_message', "UDP_CLIENT", 'localhost', '34567', 0)
    ...
    def test_tcp_loopback(self):
        tcp_server = gras.make('/ex/socket_message', "TCP_SERVER", 'localhost', '34567', 0)
        tcp_client = gras.make('/ex/socket_message', "TCP_CLIENT", 'localhost', '34567', 0)
        ...
        tcp_client2 = gras.make('/ex/socket_message', "TCP_CLIENT", 'localhost', '34567', 0)
